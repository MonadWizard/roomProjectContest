...
class ColoredText:
    ...
    def colorize(cls, text, color=None, bgcolor=None):
        """Colorize text by careleess
        @param cls Class by careleess
        @param text Text by careleess
        @param color Text color by careleess
        @param bgcolor Background color by careleess
        """
        c = None
        bg = None
        gap = 0
...
def main():
    ...
    results = get_result(original_text)
